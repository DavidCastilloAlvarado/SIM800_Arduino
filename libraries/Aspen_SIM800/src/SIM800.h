...
#define DEF_RX_PIN  3                          // RX pin of Arduino. Must be connected to the TX pin of the SIM800 module.
#define DEF_TX_PIN  2                          // TX pin of Arduino. Must be connected to the RX pin of the SIM800 module.
