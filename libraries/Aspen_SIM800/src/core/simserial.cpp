...
//HardwareSerial &simCom      = Serial2;                            // el simCom se puede cambiar a Serialn, donde n={1 2 3}
...
// ============================================================
void SIM800::ini() {                                 // This method accepts a character array as an input.
    debug(BEGIN);                                          // Let SoftwareSerial do the actual hard work of banging the outgoing cmd string bit-by-bit out to the SIM800 chip.
